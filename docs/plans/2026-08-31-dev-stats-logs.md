...
**Goal:** Surface the existing repository statistics chart and command logs directly on the Dev dashboard.
...
3. Embed a Dev Stats section with Weekly / Monthly / Total selector, existing branch controls, and existing `Chart` control.
