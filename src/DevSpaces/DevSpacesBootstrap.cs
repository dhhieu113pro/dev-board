    ...
    internal static class DevSpacesBootstrap
    {
        ...
        private sealed class RepositoryIntegration
        {
            public static RepositoryIntegration TryCreate(Views.Repository view, ViewModels.Repository repository)
            {
                ...
                var copilotItem = CreateAgentNavigationItem(view, DevSpaceAgent.BuiltIn[0]);
                var codexItem = CreateAgentNavigationItem(view, DevSpaceAgent.BuiltIn[1]);
                var antigravityItem = CreateAgentNavigationItem(view, DevSpaceAgent.BuiltIn[2]);
                ...
                pageSwitcher.Items.Add(copilotItem);
                pageSwitcher.Items.Add(codexItem);
                pageSwitcher.Items.Add(antigravityItem);
            ...
            private RepositoryIntegration(
                ...
                ListBoxItem copilotNavigationItem,
                ListBoxItem codexNavigationItem,
                ListBoxItem antigravityNavigationItem,
                ...
                Border host)
            {
                ...
                _copilotNavigationItem = copilotNavigationItem;
                _codexNavigationItem = codexNavigationItem;
                _antigravityNavigationItem = antigravityNavigationItem;
            ...
            private void OnPageSwitcherSelectionChanged(object sender, SelectionChangedEventArgs e)
            {
                ...
                switch (selectedIndex)
                {
                    ...
                    case TerminalsNavigationIndex:
                        ...
                        break;
                    case CopilotNavigationIndex:
                        OpenAgent(DevSpaceAgent.BuiltIn[0]);
                        break;
                    case CodexNavigationIndex:
                        OpenAgent(DevSpaceAgent.BuiltIn[1]);
                        break;
                    case AntigravityNavigationIndex:
                        OpenAgent(DevSpaceAgent.BuiltIn[2]);
                        break;
                    default:
            ...
            private void Update()
            {
                ...
                _copilotNavigationItem.IsVisible = enabled;
                _codexNavigationItem.IsVisible = enabled;
                _antigravityNavigationItem.IsVisible = enabled;
            ...
            private static bool IsDevSpacesNavigationIndex(int index) =>
                index >= DevSpacesNavigationIndex && index <= AntigravityNavigationIndex;
            ...
            private static ListBoxItem CreateAgentNavigationItem(Views.Repository view, DevSpaceAgent agent)
            {
                var indicator = new Rectangle
                {
                    Width = 4,
                ...
                var icon = new Image
                {
                    ...
                    Source = DevSpaceAgentIconProvider.Get(agent.Command),
                    VerticalAlignment = VerticalAlignment.Center,
                };
            ...
            private const int CopilotNavigationIndex = 8;
            private const int CodexNavigationIndex = 9;
            private const int AntigravityNavigationIndex = 10;
            ...
            private readonly ListBoxItem _copilotNavigationItem;
            private readonly ListBoxItem _codexNavigationItem;
            private readonly ListBoxItem _antigravityNavigationItem;
